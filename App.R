...
ui <- dashboardPage(
  ...
  dashboardHeader(title = div(img(src="/Users/khushijain/Superstore_Dashboard/superStore_Logo.png", height = 45, width = 50),"Superstore Sales DashBoard"),titleWidth  = "25%"),
...
server <- function(input, output, session) {
  ...
  salesDataOrig=read.csv("/Users/khushijain/Superstore_Dashboard/sales_data_cleaned.csv")
